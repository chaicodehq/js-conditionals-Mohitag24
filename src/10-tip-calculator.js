...
export function calculateTip(billAmount, serviceRating) {
  if (billAmount <= 0 || !/[1-5]/.test(serviceRating) || !Number.isInteger(serviceRating)) return null
  ...
  return {tipPercentage: tipPercentage, tipAmount: Number(tipAmount.toFixed(2)), totalAmount: Number(totalAmount.toFixed(2))}
}
